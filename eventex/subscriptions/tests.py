...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br', 'levi@leal.com.br']
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Levi Leal', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('levi@leal.com.br', email.body)
        self.assertIn('38-99193-5195', email.body)
